...
public interface ResponseStatus {
     ...
     */
    static boolean is1xxInformational(ResponseStatus status) {
     ...
     */
    static boolean is2xxSuccessful(ResponseStatus status) {
     ...
     */
    static boolean is200Ok(ResponseStatus status) {
     ...
     * @see HttpStatusCode.Successful#is2xxSuccessful(int)
     */
    static boolean is201Created(ResponseStatus status) {
     ...
     * @see HttpStatusCode.Successful#is2xxSuccessful(int)
     */
    static boolean is202Accepted(ResponseStatus status) {
     ...
     */
    static boolean is201CreatedOr202Accepted(ResponseStatus status) {
     ...
     */
    static boolean is3xxFurtherAction(ResponseStatus status) {
     ...
     */
    static boolean is3xxRedirection(ResponseStatus status) {
     ...
     * @see HttpStatusCode.FurtherAction.Redirection#isInRange(int)
     */
    static boolean is301MovedPermanently(ResponseStatus status) {
     ...
     * @see HttpStatusCode.FurtherAction.Redirection#isInRange(int)
     */
    static boolean is302MovedTemporarily(ResponseStatus status) {
     ...
     */
    static boolean is304NotModified(ResponseStatus status) {
     ...
     */
    static boolean is4xxClientError(ResponseStatus status) {
     ...
     * @see HttpStatusCode.ClientError#isInRange(int)
     */
    static boolean is400BadRequest(ResponseStatus status) {
     ...
     * @see HttpStatusCode.ClientError#isInRange(int)
     */
    static boolean is401Unauthorised(ResponseStatus status) {
     ...
     * @see HttpStatusCode.ClientError#isInRange(int)
     */
    static boolean is403Forbidden(ResponseStatus status) {
     ...
     * @see HttpStatusCode.ClientError#isInRange(int)
     */
    static boolean is404NotFound(ResponseStatus status) {
     ...
     * @see HttpStatusCode.ClientError#isInRange(int)
     */
    static boolean is405MethodNotAllowed(ResponseStatus status) {
     ...
     * @see HttpStatusCode.ClientError#isInRange(int)
     */
    static boolean is406NotAcceptable(ResponseStatus status) {
     ...
     * @see HttpStatusCode.ClientError#isInRange(int)
     */
    static boolean is409Conflict(ResponseStatus status) {
     ...
     * @see HttpStatusCode.ClientError#isInRange(int)
     */
    static boolean is413RequestEntityTooLarge(ResponseStatus status) {
     ...
     * @see HttpStatusCode.ClientError#isInRange(int)
     */
    static boolean is415UnsupportedMediaType(ResponseStatus status) {
     ...
     */
    static boolean is5xxServerError(ResponseStatus status) {
     ...
     * @see HttpStatusCode.ClientError#isInRange(int)
     */
    static boolean is500InternalServiceError(ResponseStatus status) {
