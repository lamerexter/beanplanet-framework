...
public final class CharArrayBuffer implements CharSequence, Serializable {
    ...
    public String substringTrimmed(int beginIndex, int endIndex) {
        if (beginIndex < 0) {
            ...
            int endIndex0;
            for(endIndex0 = endIndex; beginIndex0 < endIndex && Character.isWhitespace(this.buffer[beginIndex0]); ++beginIndex0) {
            }

            while(endIndex0 > beginIndex0 && Character.isWhitespace(this.buffer[endIndex0 - 1])) {
                --endIndex0;
            }
